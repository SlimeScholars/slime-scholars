...
export default function EditActivitySide({ activity, refresh, setLoading, theme }) {
    ...
    const handleNewPage = async () => {
        setLoading(true)
        try {
            await activityService.update(activity._id, [...activity.pages.map((page, num) => { return { ...page, pageNumber: num + 1 } }), {
                sections: [],
                pageNumber: activity.pages.length + 1
        ...
        try {
            await activityService.update(activity._id, [...activity.pages.map((pageData, num) => {
                if (num != page) { return { ...pageData, pageNumber: num + 1 } }
                    ...
                    return {
                        ...pageData, pageNumber: num + 1, sections: [...pageData.sections,
        ...
        try {
            await activityService.update(activity._id, [...activity.pages.map((pageData, num) => {
                if (num != page) { return { ...pageData, pageNumber: num + 1 } }
                    ...
                    return {
                        ...pageData, pageNumber: num + 1, sections: [...clone.map((item, key) => {
                            return {
        ...
        try {
            await activityService.update(activity._id, [...activity.pages.map((pageData, num) => {
                if (num != page) { return { ...pageData, pageNumber: num + 1 } }
                    ...
                    return {
                        ...pageData, pageNumber: num + 1, sections: [...pageData.sections.map((sectionData, num) => {
                    ...
                    return {
                        ...pageData, pageNumber: num + 1, sections: [...pageData.sections.map((sectionData, num) => {
                            if (num != sectionIndex) { return { ...sectionData, sectionData: num + 1 } }
                                ...
                                return {
                                    ...sectionData, sectionIndex: num + 1, elements: [...sectionData.elements,
