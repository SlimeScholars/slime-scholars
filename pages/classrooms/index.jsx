...
export default function Classroom({ user, setUser, colorPalette, setUserLoading }) {
    ...
    return (
        <div className="flex flex-col w-full h-full">
            {SCARY ?
                ...
                <>
                    <Navbar user={user} setUser={setUser} colorPalette={colorPalette} setUserLoading={setUserLoading} />
