  ...
  return (
    ...
    style={{
      ...
      style={{
        ...
        <EditActivityTitle activity={activity} refresh={refetch} setLoading={setLoading} colors={colors} setTheme={setTheme} theme={theme}/>
      </div>
      ...
      style={{
        ...
        <div className="max-h-screen overflow-y-scroll"
         style={{backgroundColor: theme.semi_light + "A0"}}>
          <EditActivitySide activity={activity} refresh={refetch} setLoading={setLoading} theme={theme}/>
        </div>
