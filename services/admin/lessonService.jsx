...
export class LessonService {
  ...
  save = async (params) =>
    this.instance
      .put("/api/admin/lesson/update-name", params, applyHeaders())
  ...
  delete = async (id) =>
    this.instance
      .delete(`/api/admin/lesson/delete?lessonId=${id}`, applyHeaders())
      .then((response) => response)
      .catch((error) => {
        showToastError(error.message);
      });
  ...
  post = async (params) =>
    this.instance
      .post("/api/admin/lesson/create", params, applyHeaders())
      .then((response) => response)
      .catch((error) => {
        showToastError(error.message);
      });
